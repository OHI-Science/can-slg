...
Ocean Health Index scores are calculated for each region for each goal before being combined into an overall Index score for Gulf of Saint Lawrence. 
...
regions <- bind_rows(
  data_frame(                
    region_id   = 0,
    region_name = 'Gulf of Saint Lawrence'),
